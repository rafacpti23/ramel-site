...
const PromotionSection = () => {
  ...
  return (
    <>
      {/* Banner fixo no topo */}
      {timeRemaining !== null && timeRemaining > 0 && showBanner && (
            ...
            <div className="container mx-auto">
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="flex items-center">
                  ...
                  <h3 className="text-sm md:text-lg font-bold">Oferta Especial: VPS R$: 29,10 com instalação de Portainer e Traefik GRÁTIS!</h3>
                </div>
